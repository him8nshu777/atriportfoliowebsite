  ...
  "Home": {
    ...
    "Image4": {
      "custom": {
        ...
        "src": "/app-assets/header%20arrow.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image11": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/right%20half%20circle.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image14": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/up%20half%20circle.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image30": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/WhatsApp%20Image%202022-12-25%20at%2000.05.50.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox84": {
      "custom": {
        "text": "How to build raporrt with your web design clients"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox82": {
      "custom": {
        "text": "Design tips for designer, that cover everything you need"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image47": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/rightUpArrow.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image54": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/last%20rock.jfif"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image59": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/DOWN%20ARRO.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox166": {
      "custom": {
        "text": "© All rights reserved.  Atri Labs / Atri Editor / Atri App"
      },
      "callbacks": {
        "onClick": [
          {
